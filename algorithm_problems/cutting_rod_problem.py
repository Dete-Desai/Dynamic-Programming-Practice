...
# We want to sell a rod of size n, and to maximize the profit, 
# we can cut it into multiple pieces. The price of a piece depends on its length, 
# to know it, we are given an array prices where prices[i] represents the price of a piece of length i.
