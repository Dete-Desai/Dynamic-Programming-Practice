...
# Given a stairs with n steps and a list of 
# possible ways to jump (for example if 
# jumps[i] = 4 then it's possible to jump by 
# 4 steps), find the total number of ways to 
# reach the nth step starting from the floor.
